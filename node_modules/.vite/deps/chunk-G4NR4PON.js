...
var NavbarCollapse = React4.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React5.forwardRef(({
  bsPrefix,
  className,
  children,
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react8.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react9.useRef)(inProp);
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react10.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
function useTransition({
  ...
  const isInitialRef = (0, import_react11.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react11.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react11.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react12.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react12.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react12.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react12.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react12.useState)(!show);
  const lastFocusRef = (0, import_react12.useRef)(null);
  (0, import_react12.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react12.useRef)();
  const removeKeydownListenerRef = (0, import_react12.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime7.jsx)("div", Object.assign({}, dialogProps, {
    children: React8.cloneElement(children, {
      role: "document"
    })
  }));
...
var OffcanvasBody = React10.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasTitle = React16.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React17.forwardRef(({
  ...
  const renderBackdrop = (0, import_react15.useCallback)((backdropProps) => (0, import_jsx_runtime16.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React18.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context = (0, import_react16.useContext)(NavbarContext_default);
...
var NavbarText = React19.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React20.forwardRef((props, ref) => {
  const {
  ...
  const handleCollapse = (0, import_react17.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react17.useMemo)(() => ({
...
//# sourceMappingURL=chunk-G4NR4PON.js.map
