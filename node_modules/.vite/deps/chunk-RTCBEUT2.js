...
var Carousel = React4.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react6.useRef)(null);
  const [direction, setDirection] = (0, import_react6.useState)("next");
  const [paused, setPaused] = (0, import_react6.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react6.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react6.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react6.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const handleEnter = (0, import_react6.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react6.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react6.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react6.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react6.useRef)(0);
  const touchDeltaXRef = (0, import_react6.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react6.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react6.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react6.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react6.useRef)();
  (0, import_react6.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react6.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
//# sourceMappingURL=chunk-RTCBEUT2.js.map
